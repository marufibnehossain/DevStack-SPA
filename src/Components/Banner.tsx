        ...
        <div className="w-full px-[4vw]">
            <div className="py-24 max-w-305 mx-auto flex sm:flex-row flex-col gap-8">
                <div className="sm:w-3/5 w-full flex flex-col justify-center">
                    <h1 className="lg:text-6xl sm:text-5xl text-3xl sm:text-left text-center font-extrabold leading-[1em] tracking-[-1.5px]">Build Your Ideal <span className="bg-linear-[to_right,#FF5722_0%,#D81B7E_50%,#7C3AED_100%] bg-clip-text text-transparent">Development Stack</span></h1>
